 ...
 * 7011 - Test Class
 *
 * This class provides a basic testing framework for the microservice 7011. It was
 * generated by the CAE (Community Application Framework).
 *
 */
public class ERhsTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(ERhs.class.getCanonicalName(),"0.1");

  private static final String mainPath = "sdsd";
